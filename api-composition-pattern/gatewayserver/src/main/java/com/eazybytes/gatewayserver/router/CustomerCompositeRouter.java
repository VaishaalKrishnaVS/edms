...
import com.eazybytes.gatewayserver.handler.CustomerCompostiteHandler;
...
public class CustomerCompositeRouter {
    ...
    @Bean
    public RouterFunction<ServerResponse> route(CustomerCompostiteHandler customerCompositeHandler){
